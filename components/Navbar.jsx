    ...
    return (
        <div ref={el} className="fixed top-0 left-0 w-full">
            ...
            <div className="w-[100vw] fixed top-0 left-0 flex items-start pt-10 px-[5vw] justify-between pointer-events-none">
                <p className="bg-neutral-900 text-neutral-100 px-2 py-1 rounded cursor-pointer transition duration-300 hover:bg-neutral-800 font-silka font-[600] tracking-wide pointer-events-auto" onClick={() => goTo('#home')}>NFT检测系统</p>
